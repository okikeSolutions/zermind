    ...
    return (
      <div {...sx("flex h-full items-center justify-center p-4")}>
        <div {...sx("text-center")}>
          ...
          ></div>
          <p {...sx("text-muted-foreground")}>Loading...</p>
        </div>
      </div>
    );
  }
    ...
    <div {...sx("p-4 sm:p-6 lg:p-8 min-h-full")}>
      <div {...sx("max-w-4xl mx-auto text-center space-y-6 sm:space-y-8")}>
        <div {...sx("space-y-2 sm:space-y-4")}>
          <h1 {...sx("text-2xl sm:text-3xl lg:text-4xl font-bold")}>Welcome to Zermind</h1>
          <p {...sx("text-muted-foreground text-base sm:text-lg")}>
            Hello <span {...sx("font-semibold")}>{user?.email}</span>
          </p>
          <p {...sx("text-muted-foreground text-sm sm:text-base mt-1 sm:mt-2")}>
            The first AI chat with <span {...sx("font-semibold text-purple-600")}>Mind Mode</span> -
        ...
        <div {...sx("grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6")}>
          <Card className="border-blue-200 bg-blue-50/50 dark:bg-blue-950/20">
            ...
            <CardContent>
              <ul {...sx("text-sm space-y-2 text-muted-foreground")}>
                ...
                <li {...sx("flex items-center gap-2")}>
                  <Bot {...sx("h-3 w-3 flex-shrink-0")} />
                  Multiple AI models
                </li>
                <li {...sx("flex items-center gap-2")}>
                  <Zap {...sx("h-3 w-3 flex-shrink-0")} />
                  Real-time streaming
                </li>
              </ul>
            </CardContent>
          ...
          <Card className="border-purple-200 bg-purple-50/50 dark:bg-purple-950/20">
            ...
            <CardContent>
              <ul {...sx("text-sm space-y-2 text-muted-foreground")}>
                <li {...sx("flex items-center gap-2")}>
                  <GitBranch {...sx("h-3 w-3 flex-shrink-0")} />
                ...
                <li {...sx("flex items-center gap-2")}>
                  <Users {...sx("h-3 w-3 flex-shrink-0")} />
                  Multi-model debates
                </li>
                <li {...sx("flex items-center gap-2")}>
                  <Share {...sx("h-3 w-3 flex-shrink-0")} />
                  Shareable mind maps
                </li>
              </ul>
            </CardContent>
        ...
        <Card className="border-2 border-dashed border-primary/20 bg-gradient-to-br from-primary/5 to-purple-500/5">
          <CardHeader className="pb-3 sm:pb-6">
            <CardTitle className="flex items-center justify-center gap-2 text-lg sm:text-xl">
              <MessageSquarePlus {...sx("h-4 w-4 sm:h-5 sm:w-5")} />

  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        {...sx(
          cn(
            "bg-background fixed z-50 flex flex-col gap-4 shadow-lg transition duration-200 ease-in-out data-ending-style:opacity-0 data-starting-style:opacity-0",
            side === "right" &&
...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div data-slot="sheet-header" {...sx(cn("flex flex-col gap-1.5 p-4", className))} {...props} />
  );
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      {...sx(cn("mt-auto flex flex-col gap-2 p-4", className))}
      {...props}
    />
  );
}
...
function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props) {
  return (
    <SheetPrimitive.Title
      ...
      {...sx(cn("text-foreground font-semibold", className))}
      {...props}
    />
  );
}
